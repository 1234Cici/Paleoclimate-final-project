...
Paleoclimate_final.Rmd: merging SST and SSS anomalies to the sheet and subsetting into six datasets according to sample locations 
Correction_script.ipynb: correcting d18O measurements for memory and drift effects. Written by Dr. Will Larsen, modified by Weidai Sun
Final_coral.ipynb: coral proxy system modeling for simulating coral d18O. Sensor model developed by Dr. Sylvia Dee, modified by Weidai Sun. 
